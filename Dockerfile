...
RUN curl --no-progress-meter -L -o /usr/local/bin/kpt-${GOOS}-${GOARCH} "${ASSET_URL}"
...
RUN curl --no-progress-meter -L -o /usr/local/bin/kind-${GOOS}-${GOARCH} "${ASSET_URL}"
...
RUN curl --no-progress-meter -L -o /usr/local/bin/clusterctl-${GOOS}-${GOARCH} "${ASSET_URL}"
